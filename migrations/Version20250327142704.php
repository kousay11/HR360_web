 ...
 */
final class Version20250327142704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE candidature ADD date_modification DATETIME NOT NULL, DROP dateModification, CHANGE id_candidature id_candidature INT NOT NULL, CHANGE id_offre id_offre INT DEFAULT NULL, CHANGE description description LONGTEXT NOT NULL, CHANGE id_user id_user INT DEFAULT NULL, CHANGE dateCandidature date_candidature DATETIME NOT NULL, CHANGE lettreMotivation lettre_motivation VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
